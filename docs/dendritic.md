...
**Actual current structure (post-Phase 5):**
```
...
modules/
  features/
    ...
    nvidia.nix                         # p1g3 only: NVIDIA driver, modesetting, Prime, nvidia-container-toolkit
    intel-gpu.nix                      # t14s only: i915 module, Intel microcode
    networking.nix                     # shared: NetworkManager, firewall
    wireguard-p1g3.nix                 # p1g3 only: WireGuard config
    wireguard-t14s.nix                 # t14s only: WireGuard config
    ...
    docker.nix                         # shared: Docker (nvidia-container-toolkit in nvidia.nix)
  ...
  home/
    ...
    parts/                             # extracted HM modules (packages, shell, editors, programs, themes, waybar, hyprlock-idle)
  hosts/
    p1g3/
      hardware-configuration.nix       # generated by nixos-generate-config
    t14s/
      hardware-configuration.nix       # placeholder — replace after T14s install
```
